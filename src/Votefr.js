...
const Votefr = () => {
  ...
  const handleSubmit = (e) => {
    ...
    //Send data to json:
    const carData = [
      { id: 1, Sécurité: firstSafety, Vitesse: firstSpeed, comfort: firstComfort, Fiabilité: firstRel },
      { id: 2, Sécurité: secondSafety, Vitesse: secondSpeed, comfort: secondComfort, Fiabilité: secondRel },
      { id: 3, Sécurité: thirdSafety, Vitesse: thirdSpeed, comfort: thirdComfort, Fiabilité: thirdRel },
      { id: 4, Sécurité: fourthSafety, Vitesse: fourthSpeed, comfort: fourthComfort, Fiabilité: fourthRel },
      { id: 5, Sécurité: fifthSafety, Vitesse: fifthSpeed, comfort: fifthComfort, Fiabilité: fifthRel },
      { id: 6, Sécurité: sixthSafety, Vitesse: sixthSpeed, comfort: sixthComfort, Fiabilité: sixthRel },
      { id: 7, Sécurité: seventhSafety, Vitesse: seventhSpeed, comfort: seventhComfort, Fiabilité: seventhRel },
      { id: 8, Sécurité: eigthSafety, Vitesse: eigthSpeed, comfort: eigthComfort, Fiabilité: eigthRel },
      { id: 9, Sécurité: ninthSafety, Vitesse: ninthSpeed, comfort: ninthComfort, Fiabilité: ninthRel }
    ];
